...
\usepackage{changepage
	...
	%  \and
	%  Derek Wu
	%  }  \email{yoav.len@math.gatech.edu}}
	%  \and
	%  Caelan Ritter
	%  \and
	%  Derek Wu
...
\newcommand*{\bdry}[1]{\partial #1}thscr\relax % just so we can load this and rsfs
\usepackage[scr]{rsfso}
\usepackage{graphicx}
\usepackage{tikz}
\usetikzlibrary{arrows, cd, calc}
...
\email{\href{mailto:caelan
		...
		\newtheorem{example}[definition]{Example}
		\theoremstyle{plain}
		\newtheorem{propositio_ritter@gatech.edu}{caelan\_ritter@gatech.edu}}
